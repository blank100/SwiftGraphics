...
public extension CGContext {
    ...
    class func bitmapContext(size: CGSize, origin: CGPoint = CGPoint.zero, color: CGColor = CGColor.clearColor()) -> CGContext! {
...
public extension CGContext {
    class func imageWithBlock(size: CGSize, color: CGColor = CGColor.clearColor(), origin: CGPoint = CGPoint.zero, block: CGContext -> Void) -> CGImage! {
